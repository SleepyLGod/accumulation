# Algorithm competition courseware

> Mostly `Fork`from [shareOI](https://github.com/hzwer/shareOI).
>
> Collected from the algorithm competition learning courseware on the Internet.
