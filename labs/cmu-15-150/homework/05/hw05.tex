% hw05.tex 
% Created by Jack Kasbeer (jkasbeer) on October 3, 2015
%
...
% ##### TASK 2 ##### %
\question{2}{Types and Polymorphism}
\begin{enumerate}
% Task 2.1 
\item \verb|Woof : 'a list * 'a -> 'a list|
% Task 2.2 
\item \verb|x : ('a -> 'b) -> 'a -> 'b|
% Task 2.3 
\item \verb|x : (int -> 'a) -> int -> 'a|
\end{enumerate}

% ##### TASK 4 ##### %
\question{4}{Integration and Differentiation}
\begin{enumerate}
% Task 4.1
\item \verb|differentiate| is defined in \verb|hw05.sml|
% Task 4.2
\item \verb|integrate| is defined in \verb|hw05.sml|
\end{enumerate}
